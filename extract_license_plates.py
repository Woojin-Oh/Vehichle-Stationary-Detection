...
file = './captured_cars/captured_car_00.png'
...
for i, matched_chars in enumerate(matched_result):
    ...
    plate_infos.append({'x': int(plate_cx-plate_width/2), 'y': int(plate_cy-plate_height/2), 'w': int(plate_width), 'h': int(plate_height)})

    output_folder = './captured_cars/license_plates/'
    os.makedirs(output_folder, exist_ok=True)
    filename = 'license_plate_00.png'
    output_file = os.path.join(output_folder, filename)
    image = Image.fromarray(img_cropped)
...
file = './captured_cars/captured_car_01.png'
